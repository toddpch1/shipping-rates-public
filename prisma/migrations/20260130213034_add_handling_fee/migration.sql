...
INSERT INTO "new_ShippingChart" ("basisType", "capPercentOfMax", "createdAt", "id", "isActive", "name", "priority", "requireAllItemsMatch", "shop", "updatedAt") SELECT "basisType", "capPercentOfMax", "createdAt", "id", "isActive", "name", "priority", "requireAllItemsMatch", "shop", "updatedAt" FROM "ShippingChart";
